...
|---|---|---|---|---|
| GET | `/` | `handle_landing` | server.py:2267 | ✅ |
| POST | `/a2a/jobs` | `handle_a2a_submit_job` | server.py:2301 |  |
| GET | `/a2a/jobs/{job_id}` | `handle_a2a_get_job` | server.py:2302 |  |
| GET | `/a2a/services` | `handle_a2a_services` | server.py:2300 | ✅ |
...
| DELETE | `/api/v1/auth/account` | `handle_account_delete` | server.py:2255 | ✅ |
| POST | `/api/v1/auth/apple` | `handle_apple_auth` | server.py:2254 | ✅ |
...
| POST | `/api/v1/iap/asn` | `handle_iap_asn` | server.py:2257 | ✅ |
| POST | `/api/v1/iap/verify` | `handle_iap_verify` | server.py:2256 | ✅ |
...
| GET | `/audit` | `handle_audit_page` | server.py:2269 | ✅ |
| POST | `/audit/request` | `handle_audit_request` | server.py:2280 |  |
| GET | `/audit/{audit_id}` | `handle_audit_report` | server.py:2281 |  |
| POST | `/auth/nonce` | `handle_auth_nonce` | server.py:2252 | ✅ |
| POST | `/auth/verify` | `handle_auth_verify` | server.py:2253 | ✅ |
| POST | `/badge/issue` | `handle_badge_issue` | server.py:2321 |  |
| GET | `/badge/widget.js` | `handle_badge_widget_js` | server.py:2316 |  |
| GET | `/badge/{badge_id}` | `handle_badge_page` | server.py:2317 |  |
| GET | `/badge/{badge_id}/embed` | `handle_badge_embed` | server.py:2319 |  |
| GET | `/badge/{badge_id}/status` | `handle_badge_status` | server.py:2318 |  |
| GET | `/badges` | `handle_badges_list` | server.py:2320 | ✅ |
...
| POST | `/certification/start` | `handle_cert_start` | server.py:2326 |  |
| POST | `/certification/submit` | `handle_cert_submit` | server.py:2327 |  |
| GET | `/certification/tracks` | `handle_cert_tracks` | server.py:2325 |  |
| GET | `/certification/{cert_id}` | `handle_cert_verify` | server.py:2328 |  |
| GET | `/chat` | `handle_chat_page` | server.py:2268 | ✅ |
| POST | `/chat` | `handle_chat` | server.py:2244 | ✅ |
| POST | `/chat/stream` | `handle_chat_stream` | server.py:2245 |  |
| GET | `/extensions/registry` | `handle_extensions_registry` | server.py:2276 | ✅ |
| GET | `/extensions/registry/{component_id}` | `handle_extensions_component` | server.py:2277 |  |
| GET | `/glasswing` | `handle_glasswing_page` | server.py:2315 | ✅ |
| GET | `/health` | `handle_health` | server.py:2247 | ✅ |
| GET | `/learn` | `handle_learn_page` | server.py:2324 | ✅ |
| GET | `/marketplace` | `handle_marketplace_page` | server.py:2270 | ✅ |
| GET | `/marketplace/plugins` | `handle_marketplace_list` | server.py:2305 |  |
| POST | `/marketplace/plugins/submit` | `handle_marketplace_submit` | server.py:2308 |  |
| GET | `/marketplace/plugins/{plugin_id}` | `handle_marketplace_plugin` | server.py:2306 |  |
| POST | `/marketplace/plugins/{plugin_id}/purchase` | `handle_marketplace_purchase` | server.py:2307 |  |
| GET | `/marketplace/purchased` | `handle_marketplace_purchased` | server.py:2309 |  |
| POST | `/memory/read` | `handle_memory_read` | server.py:2250 |  |
| POST | `/memory/write` | `handle_memory_write` | server.py:2251 |  |
| GET | `/metrics` | `handle_metrics` | server.py:2263 |  |
| GET | `/metrics/prom` | `handle_metrics_prometheus` | server.py:2264 |  |
| GET | `/privacy` | `handle_privacy_page` | server.py:2272 | ✅ |
| GET | `/ready` | `handle_ready` | server.py:2248 |  |
| POST | `/security/appattest/attest` | `handle_appattest_attest` | server.py:2262 | ✅ |
| GET | `/security/appattest/challenge` | `handle_appattest_challenge` | server.py:2261 | ✅ |
| POST | `/security/owner/request` | `handle_owner_otp_request` | server.py:2260 |  |
| POST | `/security/phone/request` | `handle_otp_request` | server.py:2258 | ✅ |
| POST | `/security/phone/verify` | `handle_otp_verify` | server.py:2259 | ✅ |
| GET | `/services/conversion` | `handle_conversion_page` | server.py:2271 | ✅ |
| GET | `/social` | `handle_social_feed_page` | server.py:2287 | ✅ |
| GET | `/social/actor/{wallet}` | `handle_social_actor` | server.py:2291 |  |
| GET | `/social/feed` | `handle_social_feed` | server.py:2288 | ✅ |
| GET | `/social/feed/stream` | `handle_social_feed_stream` | server.py:2289 | ✅ |
| POST | `/social/follow` | `handle_social_follow` | server.py:2294 |  |
| POST | `/social/post` | `handle_social_post` | server.py:2284 |  |
| GET | `/social/stats` | `handle_social_stats` | server.py:2292 | ✅ |
| GET | `/social/trending` | `handle_social_trending` | server.py:2290 | ✅ |
| POST | `/social/unfollow` | `handle_social_unfollow` | server.py:2295 |  |
| GET | `/social/{address}/followers` | `handle_social_followers` | server.py:2296 |  |
| GET | `/social/{address}/following` | `handle_social_following` | server.py:2297 |  |
| GET | `/sponsor` | `handle_sponsor_redirect` | server.py:2312 | ✅ |
| GET | `/status` | `handle_status` | server.py:2249 |  |
| GET | `/terms` | `handle_terms_page` | server.py:2273 | ✅ |
| GET | `/ws` | `handle_websocket` | server.py:2246 | ✅ |
