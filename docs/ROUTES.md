...
|---|---|---|---|---|
| GET | `/` | `handle_landing` | server.py:2398 | ✅ |
| POST | `/a2a/jobs` | `handle_a2a_submit_job` | server.py:2432 |  |
| GET | `/a2a/jobs/{job_id}` | `handle_a2a_get_job` | server.py:2433 |  |
| GET | `/a2a/services` | `handle_a2a_services` | server.py:2431 | ✅ |
...
| DELETE | `/api/v1/auth/account` | `handle_account_delete` | server.py:2386 | ✅ |
| POST | `/api/v1/auth/apple` | `handle_apple_auth` | server.py:2385 | ✅ |
...
| GET | `/api/v1/governance/daos/{daoId}/proposals` | `_handle_dao_proposals` | service_routes.py:2551 |  |
...
| POST | `/api/v1/groups` | `_handle_groups_create` | service_routes.py:2541 |  |
| POST | `/api/v1/iap/asn` | `handle_iap_asn` | server.py:2388 | ✅ |
| POST | `/api/v1/iap/verify` | `handle_iap_verify` | server.py:2387 | ✅ |
...
| POST | `/api/v1/licensing/ip` | `_handle_licensing_register_ip` | service_routes.py:2545 |  |
| POST | `/api/v1/licensing/licenses` | `_handle_licensing_create_license` | service_routes.py:2547 |  |
...
| GET | `/api/v1/messaging/conversations` | `_handle_messaging_conversations` | service_routes.py:2531 |  |
| GET | `/api/v1/messaging/conversations/{conversationId}/messages` | `_handle_messaging_messages` | service_routes.py:2532 |  |
...
| GET | `/audit` | `handle_audit_page` | server.py:2400 | ✅ |
| POST | `/audit/request` | `handle_audit_request` | server.py:2411 |  |
| GET | `/audit/{audit_id}` | `handle_audit_report` | server.py:2412 |  |
| POST | `/auth/nonce` | `handle_auth_nonce` | server.py:2383 | ✅ |
| POST | `/auth/verify` | `handle_auth_verify` | server.py:2384 | ✅ |
| POST | `/badge/issue` | `handle_badge_issue` | server.py:2452 |  |
| GET | `/badge/widget.js` | `handle_badge_widget_js` | server.py:2447 |  |
| GET | `/badge/{badge_id}` | `handle_badge_page` | server.py:2448 |  |
| GET | `/badge/{badge_id}/embed` | `handle_badge_embed` | server.py:2450 |  |
| GET | `/badge/{badge_id}/status` | `handle_badge_status` | server.py:2449 |  |
| GET | `/badges` | `handle_badges_list` | server.py:2451 | ✅ |
...
| POST | `/certification/start` | `handle_cert_start` | server.py:2457 |  |
| POST | `/certification/submit` | `handle_cert_submit` | server.py:2458 |  |
| GET | `/certification/tracks` | `handle_cert_tracks` | server.py:2456 |  |
| GET | `/certification/{cert_id}` | `handle_cert_verify` | server.py:2459 |  |
| GET | `/chat` | `handle_chat_page` | server.py:2399 | ✅ |
| POST | `/chat` | `handle_chat` | server.py:2375 | ✅ |
| POST | `/chat/stream` | `handle_chat_stream` | server.py:2376 |  |
| GET | `/extensions/registry` | `handle_extensions_registry` | server.py:2407 | ✅ |
| GET | `/extensions/registry/{component_id}` | `handle_extensions_component` | server.py:2408 |  |
| GET | `/glasswing` | `handle_glasswing_page` | server.py:2446 | ✅ |
| GET | `/health` | `handle_health` | server.py:2378 | ✅ |
| GET | `/learn` | `handle_learn_page` | server.py:2455 | ✅ |
| GET | `/marketplace` | `handle_marketplace_page` | server.py:2401 | ✅ |
| GET | `/marketplace/plugins` | `handle_marketplace_list` | server.py:2436 |  |
| POST | `/marketplace/plugins/submit` | `handle_marketplace_submit` | server.py:2439 |  |
| GET | `/marketplace/plugins/{plugin_id}` | `handle_marketplace_plugin` | server.py:2437 |  |
| POST | `/marketplace/plugins/{plugin_id}/purchase` | `handle_marketplace_purchase` | server.py:2438 |  |
| GET | `/marketplace/purchased` | `handle_marketplace_purchased` | server.py:2440 |  |
| POST | `/memory/read` | `handle_memory_read` | server.py:2381 |  |
| POST | `/memory/write` | `handle_memory_write` | server.py:2382 |  |
| GET | `/metrics` | `handle_metrics` | server.py:2394 |  |
| GET | `/metrics/prom` | `handle_metrics_prometheus` | server.py:2395 |  |
| GET | `/privacy` | `handle_privacy_page` | server.py:2403 | ✅ |
| GET | `/ready` | `handle_ready` | server.py:2379 | ✅ |
| POST | `/security/appattest/attest` | `handle_appattest_attest` | server.py:2393 | ✅ |
| GET | `/security/appattest/challenge` | `handle_appattest_challenge` | server.py:2392 | ✅ |
| POST | `/security/owner/request` | `handle_owner_otp_request` | server.py:2391 |  |
| POST | `/security/phone/request` | `handle_otp_request` | server.py:2389 | ✅ |
| POST | `/security/phone/verify` | `handle_otp_verify` | server.py:2390 | ✅ |
| GET | `/services/conversion` | `handle_conversion_page` | server.py:2402 | ✅ |
| GET | `/social` | `handle_social_feed_page` | server.py:2418 | ✅ |
| GET | `/social/actor/{wallet}` | `handle_social_actor` | server.py:2422 |  |
| GET | `/social/feed` | `handle_social_feed` | server.py:2419 | ✅ |
| GET | `/social/feed/stream` | `handle_social_feed_stream` | server.py:2420 | ✅ |
| POST | `/social/follow` | `handle_social_follow` | server.py:2425 |  |
| POST | `/social/post` | `handle_social_post` | server.py:2415 |  |
| GET | `/social/stats` | `handle_social_stats` | server.py:2423 | ✅ |
| GET | `/social/trending` | `handle_social_trending` | server.py:2421 | ✅ |
| POST | `/social/unfollow` | `handle_social_unfollow` | server.py:2426 |  |
| GET | `/social/{address}/followers` | `handle_social_followers` | server.py:2427 |  |
| GET | `/social/{address}/following` | `handle_social_following` | server.py:2428 |  |
| GET | `/sponsor` | `handle_sponsor_redirect` | server.py:2443 | ✅ |
| GET | `/status` | `handle_status` | server.py:2380 |  |
| GET | `/terms` | `handle_terms_page` | server.py:2404 | ✅ |
| GET | `/ws` | `handle_websocket` | server.py:2377 | ✅ |
