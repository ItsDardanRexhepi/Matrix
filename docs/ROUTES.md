...
**189 routes.** A **public** route requires no API key (its own auth applies — e.g. a signed JWS, SIWE, or per-IP caps).
...
| POST | `/api/v1/batch` | `_handle_batch` | service_routes.py:383 |  |
| POST | `/api/v1/brand/campaign/create` | `_handle_brand_campaign_create` | service_routes.py:255 |  |
| GET | `/api/v1/capabilities` | `_handle_capabilities_list` | service_routes.py:377 |  |
| GET | `/api/v1/capabilities/categories` | `_handle_capabilities_categories` | service_routes.py:378 |  |
| GET | `/api/v1/capabilities/{capability_id}` | `_handle_capability_detail` | service_routes.py:379 |  |
| POST | `/api/v1/capabilities/{capability_id}/invoke` | `_handle_capability_invoke` | service_routes.py:380 |  |
...
| GET | `/api/v1/events/stream` | `_handle_event_stream` | service_routes.py:384 | ✅ |
...
| GET | `/api/v1/governance/daos/{daoId}/proposals` | `_handle_dao_proposals` | service_routes.py:2269 |  |
| POST | `/api/v1/governance/multisig/approve` | `_handle_multisig_approve` | service_routes.py:342 |  |
| POST | `/api/v1/governance/multisig/propose` | `_handle_multisig_propose` | service_routes.py:341 |  |
| POST | `/api/v1/governance/proposal/create` | `_handle_governance_create` | service_routes.py:228 |  |
| POST | `/api/v1/governance/snapshot/vote` | `_handle_snapshot_vote` | service_routes.py:343 |  |
| POST | `/api/v1/governance/treasury/transfer` | `_handle_treasury_transfer` | service_routes.py:344 |  |
| POST | `/api/v1/governance/vote` | `_handle_governance_vote` | service_routes.py:229 |  |
| POST | `/api/v1/groups` | `_handle_groups_create` | service_routes.py:2259 |  |
...
| POST | `/api/v1/insurance/parametric/create` | `_handle_parametric_policy` | service_routes.py:366 |  |
| POST | `/api/v1/insurance/policy/create` | `_handle_insurance_create` | service_routes.py:220 |  |
| POST | `/api/v1/intent/execute` | `_handle_intent_execute` | service_routes.py:353 |  |
| POST | `/api/v1/intent/resolve` | `_handle_intent_resolve` | service_routes.py:352 |  |
| GET | `/api/v1/intent/summary/{plan_id}` | `_handle_intent_summary` | service_routes.py:354 |  |
| POST | `/api/v1/ip/register` | `_handle_ip_register` | service_routes.py:273 |  |
| POST | `/api/v1/licensing/ip` | `_handle_licensing_register_ip` | service_routes.py:2263 |  |
| POST | `/api/v1/licensing/licenses` | `_handle_licensing_create_license` | service_routes.py:2265 |  |
...
| GET | `/api/v1/messaging/conversations` | `_handle_messaging_conversations` | service_routes.py:2249 |  |
| GET | `/api/v1/messaging/conversations/{conversationId}/messages` | `_handle_messaging_messages` | service_routes.py:2250 |  |
...
| GET | `/api/v1/portfolio/complete/{wallet}` | `_handle_portfolio_complete` | service_routes.py:347 |  |
| GET | `/api/v1/portfolio/history/{wallet}` | `_handle_portfolio_history` | service_routes.py:349 |  |
| GET | `/api/v1/portfolio/positions/{wallet}` | `_handle_portfolio_positions` | service_routes.py:348 |  |
...
| POST | `/api/v1/realestate/buyers/verify` | `_handle_re_buyer_verify` | service_routes.py:397 |  |
| GET | `/api/v1/realestate/buyers/{wallet}/verification` | `_handle_re_buyer_verification_get` | service_routes.py:398 |  |
| GET | `/api/v1/realestate/documents/expiring` | `_handle_re_docs_expiring` | service_routes.py:396 |  |
| GET | `/api/v1/realestate/escrow/{id}` | `_handle_re_escrow_get` | service_routes.py:403 |  |
| POST | `/api/v1/realestate/escrow/{id}/confirm` | `_handle_re_escrow_confirm` | service_routes.py:400 |  |
| POST | `/api/v1/realestate/escrow/{id}/recording-complete` | `_handle_re_recording_complete` | service_routes.py:401 |  |
| POST | `/api/v1/realestate/escrow/{id}/refund` | `_handle_re_escrow_refund` | service_routes.py:402 |  |
| GET | `/api/v1/realestate/properties` | `_handle_re_property_list` | service_routes.py:390 |  |
| POST | `/api/v1/realestate/properties` | `_handle_re_property_create` | service_routes.py:389 |  |
| GET | `/api/v1/realestate/properties/{id}` | `_handle_re_property_get` | service_routes.py:391 |  |
| GET | `/api/v1/realestate/properties/{id}/documents` | `_handle_re_documents_get` | service_routes.py:394 |  |
| POST | `/api/v1/realestate/properties/{id}/documents` | `_handle_re_document_upload` | service_routes.py:393 |  |
| GET | `/api/v1/realestate/properties/{id}/readiness` | `_handle_re_readiness` | service_routes.py:395 |  |
| POST | `/api/v1/realestate/properties/{id}/status` | `_handle_re_property_status` | service_routes.py:392 |  |
| POST | `/api/v1/realestate/purchase` | `_handle_re_purchase` | service_routes.py:399 |  |
...
| POST | `/api/v1/supply-chain/custody/transfer` | `_handle_custody_transfer` | service_routes.py:363 |  |
| POST | `/api/v1/supply-chain/provenance/log` | `_handle_provenance_log` | service_routes.py:361 |  |
| POST | `/api/v1/supply-chain/register` | `_handle_supply_chain_register` | service_routes.py:267 |  |
| POST | `/api/v1/supply-chain/verify` | `_handle_authenticity_verify` | service_routes.py:362 |  |
