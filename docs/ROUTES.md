...
**206 routes.** A **public** route requires no API key (its own auth applies — e.g. a signed JWS, SIWE, or per-IP caps).
...
| POST | `/api/v1/batch` | `_handle_batch` | service_routes.py:387 |  |
| POST | `/api/v1/brand/campaign/create` | `_handle_brand_campaign_create` | service_routes.py:255 |  |
| GET | `/api/v1/capabilities` | `_handle_capabilities_list` | service_routes.py:381 |  |
| GET | `/api/v1/capabilities/categories` | `_handle_capabilities_categories` | service_routes.py:382 |  |
| GET | `/api/v1/capabilities/{capability_id}` | `_handle_capability_detail` | service_routes.py:383 |  |
| POST | `/api/v1/capabilities/{capability_id}/invoke` | `_handle_capability_invoke` | service_routes.py:384 |  |
...
| GET | `/api/v1/events/stream` | `_handle_event_stream` | service_routes.py:388 | ✅ |
...
| GET | `/api/v1/governance/daos/{daoId}/proposals` | `_handle_dao_proposals` | service_routes.py:2320 |  |
...
| POST | `/api/v1/groups` | `_handle_groups_create` | service_routes.py:2310 |  |
...
| POST | `/api/v1/licensing/ip` | `_handle_licensing_register_ip` | service_routes.py:2314 |  |
| POST | `/api/v1/licensing/licenses` | `_handle_licensing_create_license` | service_routes.py:2316 |  |
...
| GET | `/api/v1/messaging/conversations` | `_handle_messaging_conversations` | service_routes.py:2300 |  |
| GET | `/api/v1/messaging/conversations/{conversationId}/messages` | `_handle_messaging_messages` | service_routes.py:2301 |  |
...
| POST | `/api/v1/realestate/buyers/verify` | `_handle_re_buyer_verify` | service_routes.py:401 |  |
| GET | `/api/v1/realestate/buyers/{wallet}/verification` | `_handle_re_buyer_verification_get` | service_routes.py:402 |  |
| GET | `/api/v1/realestate/documents/expiring` | `_handle_re_docs_expiring` | service_routes.py:400 |  |
| GET | `/api/v1/realestate/escrow/{id}` | `_handle_re_escrow_get` | service_routes.py:407 |  |
| POST | `/api/v1/realestate/escrow/{id}/confirm` | `_handle_re_escrow_confirm` | service_routes.py:404 |  |
| POST | `/api/v1/realestate/escrow/{id}/recording-complete` | `_handle_re_recording_complete` | service_routes.py:405 |  |
| POST | `/api/v1/realestate/escrow/{id}/refund` | `_handle_re_escrow_refund` | service_routes.py:406 |  |
| GET | `/api/v1/realestate/properties` | `_handle_re_property_list` | service_routes.py:394 |  |
| POST | `/api/v1/realestate/properties` | `_handle_re_property_create` | service_routes.py:393 |  |
| GET | `/api/v1/realestate/properties/{id}` | `_handle_re_property_get` | service_routes.py:395 |  |
| GET | `/api/v1/realestate/properties/{id}/documents` | `_handle_re_documents_get` | service_routes.py:398 |  |
| POST | `/api/v1/realestate/properties/{id}/documents` | `_handle_re_document_upload` | service_routes.py:397 |  |
| GET | `/api/v1/realestate/properties/{id}/readiness` | `_handle_re_readiness` | service_routes.py:399 |  |
| POST | `/api/v1/realestate/properties/{id}/status` | `_handle_re_property_status` | service_routes.py:396 |  |
| POST | `/api/v1/realestate/purchase` | `_handle_re_purchase` | service_routes.py:403 |  |
