...
**213 routes.** A **public** route requires no API key (its own auth applies — e.g. a signed JWS, SIWE, or per-IP caps).

| Method | Path | Handler | Source | Public |
|---|---|---|---|---|
| GET | `/` | `handle_landing` | server.py:2249 | ✅ |
| POST | `/a2a/jobs` | `handle_a2a_submit_job` | server.py:2283 |  |
| GET | `/a2a/jobs/{job_id}` | `handle_a2a_get_job` | server.py:2284 |  |
| GET | `/a2a/services` | `handle_a2a_services` | server.py:2282 | ✅ |
...
| DELETE | `/api/v1/auth/account` | `handle_account_delete` | server.py:2237 | ✅ |
| POST | `/api/v1/auth/apple` | `handle_apple_auth` | server.py:2236 | ✅ |
...
| GET | `/api/v1/governance/daos/{daoId}/proposals` | `_handle_dao_proposals` | service_routes.py:2329 |  |
...
| POST | `/api/v1/groups` | `_handle_groups_create` | service_routes.py:2319 |  |
| POST | `/api/v1/iap/asn` | `handle_iap_asn` | server.py:2239 | ✅ |
| POST | `/api/v1/iap/verify` | `handle_iap_verify` | server.py:2238 | ✅ |
...
| POST | `/api/v1/licensing/ip` | `_handle_licensing_register_ip` | service_routes.py:2323 |  |
| POST | `/api/v1/licensing/licenses` | `_handle_licensing_create_license` | service_routes.py:2325 |  |
...
| GET | `/api/v1/messaging/conversations` | `_handle_messaging_conversations` | service_routes.py:2309 |  |
| GET | `/api/v1/messaging/conversations/{conversationId}/messages` | `_handle_messaging_messages` | service_routes.py:2310 |  |
...
| GET | `/audit` | `handle_audit_page` | server.py:2251 | ✅ |
| POST | `/audit/request` | `handle_audit_request` | server.py:2262 |  |
| GET | `/audit/{audit_id}` | `handle_audit_report` | server.py:2263 |  |
| POST | `/auth/nonce` | `handle_auth_nonce` | server.py:2234 | ✅ |
| POST | `/auth/verify` | `handle_auth_verify` | server.py:2235 | ✅ |
| POST | `/badge/issue` | `handle_badge_issue` | server.py:2303 |  |
| GET | `/badge/widget.js` | `handle_badge_widget_js` | server.py:2298 |  |
| GET | `/badge/{badge_id}` | `handle_badge_page` | server.py:2299 |  |
| GET | `/badge/{badge_id}/embed` | `handle_badge_embed` | server.py:2301 |  |
| GET | `/badge/{badge_id}/status` | `handle_badge_status` | server.py:2300 |  |
| GET | `/badges` | `handle_badges_list` | server.py:2302 | ✅ |
...
| POST | `/certification/start` | `handle_cert_start` | server.py:2308 |  |
| POST | `/certification/submit` | `handle_cert_submit` | server.py:2309 |  |
| GET | `/certification/tracks` | `handle_cert_tracks` | server.py:2307 |  |
| GET | `/certification/{cert_id}` | `handle_cert_verify` | server.py:2310 |  |
| GET | `/chat` | `handle_chat_page` | server.py:2250 | ✅ |
| POST | `/chat` | `handle_chat` | server.py:2226 | ✅ |
| POST | `/chat/stream` | `handle_chat_stream` | server.py:2227 |  |
| GET | `/extensions/registry` | `handle_extensions_registry` | server.py:2258 | ✅ |
| GET | `/extensions/registry/{component_id}` | `handle_extensions_component` | server.py:2259 |  |
| GET | `/glasswing` | `handle_glasswing_page` | server.py:2297 | ✅ |
| GET | `/health` | `handle_health` | server.py:2229 | ✅ |
| GET | `/learn` | `handle_learn_page` | server.py:2306 | ✅ |
| GET | `/marketplace` | `handle_marketplace_page` | server.py:2252 | ✅ |
| GET | `/marketplace/plugins` | `handle_marketplace_list` | server.py:2287 |  |
| POST | `/marketplace/plugins/submit` | `handle_marketplace_submit` | server.py:2290 |  |
| GET | `/marketplace/plugins/{plugin_id}` | `handle_marketplace_plugin` | server.py:2288 |  |
| POST | `/marketplace/plugins/{plugin_id}/purchase` | `handle_marketplace_purchase` | server.py:2289 |  |
| GET | `/marketplace/purchased` | `handle_marketplace_purchased` | server.py:2291 |  |
| POST | `/memory/read` | `handle_memory_read` | server.py:2232 |  |
| POST | `/memory/write` | `handle_memory_write` | server.py:2233 |  |
| GET | `/metrics` | `handle_metrics` | server.py:2245 |  |
| GET | `/metrics/prom` | `handle_metrics_prometheus` | server.py:2246 |  |
| GET | `/privacy` | `handle_privacy_page` | server.py:2254 | ✅ |
| GET | `/ready` | `handle_ready` | server.py:2230 |  |
| POST | `/security/appattest/attest` | `handle_appattest_attest` | server.py:2244 | ✅ |
| GET | `/security/appattest/challenge` | `handle_appattest_challenge` | server.py:2243 | ✅ |
| POST | `/security/owner/request` | `handle_owner_otp_request` | server.py:2242 |  |
| POST | `/security/phone/request` | `handle_otp_request` | server.py:2240 | ✅ |
| POST | `/security/phone/verify` | `handle_otp_verify` | server.py:2241 | ✅ |
| GET | `/services/conversion` | `handle_conversion_page` | server.py:2253 | ✅ |
| GET | `/social` | `handle_social_feed_page` | server.py:2269 | ✅ |
| GET | `/social/actor/{wallet}` | `handle_social_actor` | server.py:2273 |  |
| GET | `/social/feed` | `handle_social_feed` | server.py:2270 | ✅ |
| GET | `/social/feed/stream` | `handle_social_feed_stream` | server.py:2271 | ✅ |
| POST | `/social/follow` | `handle_social_follow` | server.py:2276 |  |
| POST | `/social/post` | `handle_social_post` | server.py:2266 |  |
| GET | `/social/stats` | `handle_social_stats` | server.py:2274 | ✅ |
| GET | `/social/trending` | `handle_social_trending` | server.py:2272 | ✅ |
| POST | `/social/unfollow` | `handle_social_unfollow` | server.py:2277 |  |
| GET | `/social/{address}/followers` | `handle_social_followers` | server.py:2278 |  |
| GET | `/social/{address}/following` | `handle_social_following` | server.py:2279 |  |
| GET | `/sponsor` | `handle_sponsor_redirect` | server.py:2294 | ✅ |
| GET | `/status` | `handle_status` | server.py:2231 |  |
| GET | `/terms` | `handle_terms_page` | server.py:2255 | ✅ |
| GET | `/ws` | `handle_websocket` | server.py:2228 | ✅ |
