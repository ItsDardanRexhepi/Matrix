    ...
    async def _gas_price(self, params: dict) -> str:
        ...
        try:
            ...
            return json.dumps({
                ...
                "note": "Gas is sponsored by the platform paymaster within the operator's sponsorship policy; outside it, sponsorship is refused",
                "network": self.network,
            }, indent=2)
        except Exception as e:
            return refusal(
    ...
    async def _platform_stats(self, params: dict) -> str:
        ...
        try:
            ...
            return json.dumps({
                ...
                "gas_price_gwei": str(self.web3.from_wei(gas_price, "gwei")),
                "gas_policy": "Gas is sponsored by the platform paymaster within the operator's sponsorship policy; outside it, sponsorship is refused",
            }, indent=2)
        except Exception as e:
            return refusal(
