...
import "../MatrixMarketplace.sol";
import "../MatrixNFT.sol";

/// @title MatrixMarketplace.t.sol
/// @notice Marketplace: list item, buy item, cancel, update price.
contract MatrixMarketplaceTest is Test {
    MatrixMarketplace internal marketplace;
    ...
    function setUp() public {
        ...
        bob = makeAddr("bob");
        marketplace = new MatrixMarketplace(feeRecipient);
        nft = new MatrixNFT(feeRecipient, 500, 0); // 0 mint price
    }

    function test_Constructor_RevertsOnZeroRecipient() public {
        vm.expectRevert("Zero fee recipient");
        new MatrixMarketplace(address(0));
    }
