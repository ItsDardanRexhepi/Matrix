...
import "../MatrixPaymaster.sol";

/// @title MatrixPaymaster.t.sol
/// @notice Unit tests for the gas sponsorship contract.
contract MatrixPaymasterTest is Test {
    MatrixPaymaster internal paymaster;
    ...
    function setUp() public {
        ...
        user = makeAddr("user");
        paymaster = new MatrixPaymaster(PLATFORM);
    }
...
contract GasHungryWallet {
    ...
    function pullFromPaymaster(MatrixPaymaster paymaster, uint256 amount) external {
