...
contract OpenMatrixDAODrainTest is Test {
    ...
    function setUp() public {
        dao = new OpenMatrixDAO(feeRecipient);   // this contract is the owner
    ...
    function test_OneTwentyFourthUnopposed_CannotDrain() public {
        ...
        vm.prank(attacker);
        uint256 id = dao.propose(targets, values, calldatas, "pay me", OpenMatrixDAO.VotingModel.SimpleMajority);
