...
/// @title MatrixNFT.t.sol
/// @notice ERC-721 minting and royalty tests for the MatrixNFT contract.
contract MatrixNFTTest is Test {
    MatrixNFT internal nft;
