...
import "../MatrixVerifyingPaymaster.sol";
...
contract MatrixVerifyingPaymasterTest is Test {
    MatrixVerifyingPaymaster internal pm;
    ...
    function setUp() public {
        ...
        pm = new MatrixVerifyingPaymaster(IEntryPoint(address(this)), signer, owner);
    }
    ...
    function test_digest_vector() public view {
        bytes32 d = pm.digest(MatrixVerifyingPaymaster.DigestInput({
