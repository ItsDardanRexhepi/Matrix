...
import "../MatrixDID.sol";

/// @title MatrixDID.t.sol
/// @notice DID lifecycle: create, resolve, update, deactivate.
contract MatrixDIDTest is Test {
    MatrixDID internal did;
    ...
    function test_DidFor_ReturnsFormattedString() public view {
        ...
        // First 20 bytes should spell "did:matrix:base:"
        bytes memory expectedPrefix = bytes("did:matrix:base:");
