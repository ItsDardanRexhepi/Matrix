...
contract OpenMatrixInsuranceBackrunTest is Test {
    ...
    function test_BuyAndClaimInTheTriggersBlock_Reverts() public {
        ...
        uint256 premium = insurance.calculatePremium(100 ether, OpenMatrixInsurance.RiskTier.Low);
        assertEq(premium, 2 ether, "50:1 at Low");
        vm.prank(attacker);
        uint256 id = insurance.purchasePolicy{value: premium}(100 ether, OpenMatrixInsurance.RiskTier.Low, COND);
