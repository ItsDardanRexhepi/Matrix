# The Matrix Sponsor Tiers

Thank you for considering sponsoring The Matrix. Your support keeps this platform free for everyone and funds the infrastructure, development, and iOS app maintenance that make it all possible.
...
For individuals who believe in the mission and want to help keep The Matrix free for everyone.
...
For developers, creators, and professionals who use The Matrix and want to invest in its future.
...
For companies, teams, and power users who depend on The Matrix and want to shape where it goes next.
...
For organizations that rely on The Matrix at scale and want a direct line to the team.

**What you get:**
- Everything in Builder
- Your logo featured on the Matrix landing page at openmatrix-ai.com
...
For visionary organizations that want to be permanently woven into the story of The Matrix. Founding Sponsors are not just supporters -- they are partners.

**What you get:**
- Everything in Infrastructure Partner
- White-label rights -- use The Matrix technology under your own brand, subject to a separate licensing agreement
- Custom component development priority -- when you need a feature built, it goes to the top of the backlog
- Named in all press releases, launch announcements, and public communications about The Matrix
...
- **Open Collective:** [opencollective.com/the-matrix](https://opencollective.com/the-matrix)
